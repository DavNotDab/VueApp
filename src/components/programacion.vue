...
<!-- Componente que recoge los cursos de la categoria programacion -->
...
// Obtiene los cursos de la base de datos de la categoria programacion
let cursos;
...
<template>
    ...
    <div v-else>
        <cursos>
            ...
            <!-- Muestra los cursos de la categoria programacion -->
